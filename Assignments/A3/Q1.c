...
// Description: read a square matrix from a file (matrix.txt), extract a submatrix by selecting maximum values from 2x2 blocks, 
// and print both the original and the submatrix.
