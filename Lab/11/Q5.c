...
// Description: Define nested structures for an Organization and its Employees, then initializes data for "NU-Fast" with a specific 
// organization number and an employee with an ID, name, and salary, and output the organization's size and the specified details.
